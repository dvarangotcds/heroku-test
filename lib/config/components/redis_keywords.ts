...
export default class RedisKeywords implements IValidate {
  ...
  private setVariables() {
    this.port = Number(process.env.REDIS_KEYWORDS_PORT)
    this.host = process.env.REDIS_KEYWORDS_HOST + ''
    this.password = process.env.REDIS_KEYWORDS_PASSWORD + ''
  }
}
